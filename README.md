...
본편만 설치하면 **원본 ISO만** 확인합니다. **치트·클리어 세이브를 선택할 때** PPSSPP·메모리스틱 자동 탐색을 시작하고, 여러 후보는 입력 칸의 **▼**에서 고릅니다. HD만 설치할 때는 텍스처를 넣을 메모리스틱 폴더만 지정합니다. 치트·세이브도 메모리스틱을 직접 지정하면 PPSSPP 실행 파일 없이 설치할 수 있습니다. HD·치트·세이브는 기본 선택이 꺼져 있습니다. [런처 사용법](launcher/README-ko.md) · [런처 소스](launcher/)
